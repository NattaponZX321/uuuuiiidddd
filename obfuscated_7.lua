...
do
    if game:GetService("CoreGui"):FindFirstChild("NattaponHubUI") then
        game:GetService("CoreGui").NattaponHubUI:Destroy()
...
function a:Window(f, f, f)
    ...
    function d:Tab(d, f)
        ...
        function a:Slider(a, c, d, e, g)
            ...
            l.Image = "rbxassetid://17719617126"
            m.Parent = j
